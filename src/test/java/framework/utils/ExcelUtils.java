...
public class ExcelUtils {
    ...
    public String getCellValue(String sheetName, int rowNum, int colNum) {
        try {
            ...
            logger.warn("Failed to get cell value at row number '" + String.valueOf(rowNum) + "' and column number '" + colNum + "' on sheet with name '" + sheetName + "'.");
            return "";
        }
    }
    ...
    public String getCellValue(String sheetName, String cellAddress) {
        ...
        try {
            ...
            logger.debug(this, npe);
            logger.warn("Failed to get value of cell '" + cellAddress + "' on sheet with name '" + sheetName + "'.");
            return "";
        }
    }
    ...
    /**
     * Get map of existing sheet selenium
     *
     * @return Map of existing sheet selenium
     */
    ...
    public void addSheet(String sheetName) {
        try {
            ...
            logger.debug(this, ex);
            logger.warn("Sheet with name '" + sheetName + "' already exists.");
        }
    }
    ...
    public void save(String fileName) {
        try {
            ...
            logger.debug(this, ex);
            logger.warn("Can't create Excel file with name '" + fileName + "'.");
        }
    }
    ...
    private int[] getRowAndColIndexes(String cellAddress) {
        ...
        // Row index
        result[0] = Integer.parseInt(StringFunctions.regexGetMatch(cellAddress, "\\d+")) - 1;

        // Column index
        result[1] = getColIndexByName(StringFunctions.regexGetMatch(cellAddress, "[a-zA-Z]+"));
        return result;
    }
}